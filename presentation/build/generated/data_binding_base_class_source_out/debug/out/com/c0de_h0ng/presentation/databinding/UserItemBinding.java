...
public abstract class UserItemBinding extends ViewDataBinding {
  @NonNull
  public final ConstraintLayout apiUserItem;
  ...
  protected UserItemBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ConstraintLayout apiUserItem, ImageView ivProfile, TextView tvName) {
    super(_bindingComponent, _root, _localFieldCount);
    this.apiUserItem = apiUserItem;
    this.ivProfile = ivProfile;
    this.tvName = tvName;
  }

  public abstract void setProfileUrl(@Nullable String profileUrl);
