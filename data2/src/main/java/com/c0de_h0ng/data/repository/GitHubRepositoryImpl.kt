...
import com.c0de_h0ng.domain.model.User2
...
class GitHubRepositoryImpl @Inject constructor(
    ...
    override suspend fun getUserList(searchWord: String): List<User2> {
        return remote.getUserList(searchWord).toUserList()
    }

    override fun getRxUserList(searchWord: String): Flowable<List<User2>> {
